...
export const productBreakdowns: ProductBreakdown[] = [
  ...
  },
  {
    ...
    layerLabel: "Full-Stack SaaS Boilerplate",
    color: "#10b981",
    whatItIs: "Same idea as Shipped — a complete SaaS starter. But this one uses Supabase (PostgreSQL) instead of MongoDB, and Lemon Squeezy instead of Stripe.",
    whatItDoes: [
      "NextAuth authentication (Google, GitHub OAuth + email/password)",
      "Lemon Squeezy payments with subscription management",
    ...
    uniqueness: "Only boilerplate built on Supabase + Lemon Squeezy + shadcn/ui. Has i18n and blog built in. Closest to your existing stack (you already use Supabase).",
    similarTo: "Shipped, ShipFast — but Supabase instead of MongoDB, Lemon Squeezy instead of Stripe",
  ...
  },
  {
    ...
    whatItDoes: [
      ...
      "Stripe OR Lemon Squeezy payments (you pick)",
    ...
    uniqueness: "Cheapest full-stack option at $199. Lets you pick Stripe OR Lemon Squeezy, MongoDB OR Supabase. Most flexible database/payment combo.",
